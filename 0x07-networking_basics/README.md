...
This project gave an insight into the basics of networking. I was able to learn and answer some quiz  and some bash script on the OSI(Open Systems Interconnection) mode,How many layers it has,How it is organized. 
Icluding the LAN and WAN networks, and TCP/UDP data transfer protocols.
